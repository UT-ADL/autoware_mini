...
class StandingPedestrianCrossing2(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=60):
        ...
        self._pedestrian_spawn_point = carla.Location(x=200, y=534, z=36.0)
        self._pedestrian_heading = -31  # in degrees, as requested
        ...
        super(StandingPedestrianCrossing2, self).__init__(
            "StandingPedestrianCrossing2",
        ...
        if debug_mode:
            print("StandingPedestrianCrossing2 scenario initialized with NO ego vehicle dependency")
    ...
    def _initialize_actors(self, config):
        ...
        walker = CarlaDataProvider.request_new_actor('walker.pedestrian.0004', spawn_transform)
        if walker is None:
...
def get_available_scenarios():
    ...
    """
    return {"StandingPedestrianCrossing2": StandingPedestrianCrossing2}