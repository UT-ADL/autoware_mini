...
class RightTurnPedestrianCrossing2(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=60):
        ...
        self._pedestrian_spawn_point = carla.Location(x=-77, y=-91, z=36.0)
        self._pedestrian_heading = -60  # in degrees, as requested
        
        # Scenario parameters
        self._adversary_speed = 1.5     # Speed of the pedestrian [m/s]
        self._first_segment_distance = 22.0  # First walking segment [m]
        ...
        self._second_heading = self._pedestrian_heading - 264
        ...
        super(RightTurnPedestrianCrossing2, self).__init__(
            "RightTurnPedestrianCrossing2",
        ...
        if debug_mode:
            print("RightTurnPedestrianCrossing2 scenario initialized with NO ego vehicle dependency")
    ...
    def _initialize_actors(self, config):
        ...
        walker = CarlaDataProvider.request_new_actor('walker.pedestrian.0011', spawn_transform)
        if walker is None:
...
def get_available_scenarios():
    ...
    """
    return {"RightTurnPedestrianCrossing2": RightTurnPedestrianCrossing2}