...
class VehicleRoundabout1(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._destination_coords = carla.Location(x=48, y=-243, z=37)
        self._spawn_coords = carla.Location(x=27, y=-209, z=36)
        ...
        super(VehicleRoundabout1, self).__init__(
            "VehicleRoundabout1",
            ego_vehicles,
            config,
            world,
    ...
    def _initialize_actors(self, config):
        ...
        blueprint = self._world.get_blueprint_library().find('vehicle.mercedes.coupe_2020')
    ...
    def _log_scenario_info(self, complete_route):
        ...
        print(f"Scenario: VehicleRoundabout1")
    ...
    def _create_behavior(self):
        ...
        class DriveToDestination(py_trees.behaviour.Behaviour):
            def __init__(self, scenario):
                ...
                self.delay_duration = 3.0  # 4 seconds delay
            ...
            def initialise(self):
                ...
                if self.scenario._keep_running:
                    self._success_returned = False
                    self.agent_done = False
                    print(f"Scenario triggered - waiting {self.delay_duration} seconds before vehicle starts moving...")
                else:
            ...
            def update(self):
                ...
                if not self.delay_completed:
                    if time.time() - self.delay_start_time < self.delay_duration:
                        # Still in delay period - vehicle should remain stationary
                        vehicle = self.scenario._agent_vehicle
                        if vehicle and vehicle.is_alive:
                            # Apply zero control to keep vehicle stationary
                        ...
                        print("Delay completed - vehicle starting movement...")
                ...
                # Control vehicle (only after delay is completed)
    ...
    def terminate(self):
        ...
        super(VehicleRoundabout1, self).terminate()

def get_available_scenarios():
    return {"VehicleRoundabout1": VehicleRoundabout1}