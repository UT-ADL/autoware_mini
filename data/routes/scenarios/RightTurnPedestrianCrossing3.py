...
class RightTurnPedestrianCrossing3(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=60):
        ...
        self._pedestrian_spawn_point = carla.Location(x=33, y=-118, z=36.0)
        self._pedestrian_heading = 105  # in degrees, as requested
        
        # Scenario parameters
        self._adversary_speed = 1.5     # Speed of the pedestrian [m/s]
        self._first_segment_distance = 25.0  # First walking segment [m]
        self._second_segment_distance = 21.0  # Second walking segment after turn [m]
        self._idle_time = 0.0           # No idle time - start immediately
        self._turn_time = 1.0           # Time to complete the turn [s]
        ...
        self._second_heading = self._pedestrian_heading - 295
        ...
        super(RightTurnPedestrianCrossing3, self).__init__(
            "RightTurnPedestrianCrossing3",
        ...
        if debug_mode:
            print("RightTurnPedestrianCrossing3 scenario initialized with NO ego vehicle dependency")
    ...
    def _initialize_actors(self, config):
        ...
        walker = CarlaDataProvider.request_new_actor('walker.pedestrian.0012', spawn_transform)
        if walker is None:
    ...
    def _create_behavior(self):
        ...
        sequence = py_trees.composites.Sequence("PedestrianLeftTurnSequence")
...
def get_available_scenarios():
    ...
    """
    return {"RightTurnPedestrianCrossing3": RightTurnPedestrianCrossing3}