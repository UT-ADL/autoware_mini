...
class VehicleRoundabout3(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._destination_coords = carla.Location(x=50, y=98, z=35)
        
        # Use the specific scene coordinates provided
        self._spawn_coords = carla.Location(x=34.5, y=-224, z=37)
        self._spawn_yaw = 110  # Default spawn yaw in degrees - you can change this value
        ...
        self._waypoint_list = [
            [33.625835, -222.298431, 37, 50, 1],        # Road waypoint
            [32.863506, -220.477280, 36.406269, 50, 1],
        ]
        ...
        super(VehicleRoundabout3, self).__init__(
            "VehicleRoundabout3",
            ego_vehicles,
            config,
            world,
    ...
    def _initialize_actors(self, config):
        ...
        blueprint = self._world.get_blueprint_library().find('vehicle.nissan.patrol_2021')
    ...
    def _create_route(self, agent, current_waypoint, destination_waypoint):
        ...
        print(f"Scenario: VehicleRoundabout3")
    ...
    def terminate(self):
        ...
        super(VehicleRoundabout3, self).terminate()

def get_available_scenarios():
    return {"VehicleRoundabout3": VehicleRoundabout3}