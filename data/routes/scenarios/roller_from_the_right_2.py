...
class RollerFromTheRight2(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._destination_coords = carla.Location(x=-200, y=362, z=36)
        
        # Use the specific scene coordinates provided
        self._spawn_coords = carla.Location(x=-10, y=622, z=36.0)
        self._spawn_yaw = 200  # Default spawn yaw in degrees - you can change this value
        ...
        self._waypoint_list = [
            [-17, 618, 36.0, 50, 1],    # Direct waypoint
            #[119, 805, 36, 30, 1],        # Road waypoint
            #[119, 807, 36, 30, 0], # Road waypoint
            #[120, 810, 36, 30, 1], # Road waypoint
            #[129, 820, 36, 30, 1], # Road waypoint
            #[129, 825, 36, 30, 1], # Road waypoint
            #[125, 840, 36, 30, 1], # Road waypoint
        ]
        ...
        super(RollerFromTheRight2, self).__init__(
            "RollerFromTheRight2",
            ego_vehicles,
            config,
            world,
    ...
    def _initialize_actors(self, config):
        ...
        blueprint = self._world.get_blueprint_library().find('vehicle.yamaha.yzf')
        ...
        agent.ignore_vehicles(True)  # Start with ignoring vehicles
    ...
    def _create_route(self, agent, current_waypoint, destination_waypoint):
        ...
        print(f"Scenario: RollerFromTheRight2")
    ...
    def _create_behavior(self):
        ...
        class DriveToDestination(py_trees.behaviour.Behaviour):
            def __init__(self, scenario):
                ...
                self._ignore_vehicles_reset = False  # Track if we have reset ignore_vehicles
            ...
            def initialise(self):
                ...
                self.last_ego_check = 0
                self.last_viz = 0
                self._ignore_vehicles_reset = False  # Reset flag
            ...
            def update(self):
                ...
                # After 3 seconds (approx 30 ticks), stop ignoring vehicles
                if not self._ignore_vehicles_reset and self.running_time >= 120:
                    agent.ignore_vehicles(False)
                    self._ignore_vehicles_reset = True
    ...
    def terminate(self):
        ...
        super(RollerFromTheRight2, self).terminate()

def get_available_scenarios():
    return {"RollerFromTheRight2": RollerFromTheRight2}