...
class PedestrianCrossingKaubamaja2(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=60):
        ...
        self._pedestrian_spawn_point = carla.Location(x=140, y=789, z=36.0)
        ...
        super(PedestrianCrossingKaubamaja2, self).__init__(
            "PedestrianCrossingKaubamaja2",
        ...
        if debug_mode:
            print("PedestrianCrossingKaubamaja2 scenario initialized with NO ego vehicle dependency")
    ...
    def _initialize_actors(self, config):
        ...
        walker = CarlaDataProvider.request_new_actor('walker.pedestrian.0008', spawn_transform)
        if walker is None:
...
def get_available_scenarios():
    ...
    """
    return {"PedestrianCrossingKaubamaja2": PedestrianCrossingKaubamaja2}