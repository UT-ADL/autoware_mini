...
class VehicleRoundabout2(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._destination_coords = carla.Location(x=-278, y=158, z=37)
        self._spawn_coords = carla.Location(x=20, y=-101, z=36)
        ...
        super(VehicleRoundabout2, self).__init__(
            "VehicleRoundabout2",
            ego_vehicles,
            config,
            world,
    ...
    def _log_scenario_info(self, complete_route):
        ...
        print(f"Scenario: VehicleRoundabout2")
    ...
    def terminate(self):
        ...
        super(VehicleRoundabout2, self).terminate()

def get_available_scenarios():
    return {"VehicleRoundabout2": VehicleRoundabout2}