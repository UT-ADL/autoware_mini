...
class RollerFromTheRight1(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._destination_coords = carla.Location(x=94, y=868, z=38)
        
        # Use the specific scene coordinates provided
        self._spawn_coords = carla.Location(x=163, y=767, z=36.0)
        self._spawn_yaw = 130  # Default spawn yaw in degrees - you can change this value
        ...
        self._waypoint_list = [
            [139, 790, 36.0, 30, 1],    # Direct waypoint
            [121, 806, 36, 30, 1],        # Road waypoint
        ...
        super(RollerFromTheRight1, self).__init__(
            "RollerFromTheRight1",
            ego_vehicles,
            config,
            world,
    ...
    def _initialize_actors(self, config):
        ...
        blueprint = self._world.get_blueprint_library().find('vehicle.vespa.zx125')
    ...
    def _create_route(self, agent, current_waypoint, destination_waypoint):
        ...
        print(f"Scenario: RollerFromTheRight1")
    ...
    def terminate(self):
        ...
        super(RollerFromTheRight1, self).terminate()

def get_available_scenarios():
    return {"RollerFromTheRight1": RollerFromTheRight1}