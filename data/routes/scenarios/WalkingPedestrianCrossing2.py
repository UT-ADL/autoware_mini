...
class WalkingPedestrianCrossing2(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=60):
        ...
        self._pedestrian_spawn_point = carla.Location(x=218, y=524, z=35.0)
        self._pedestrian_heading = 149  # in degrees, as requested
        
        # Scenario parameters
        self._adversary_speed = 1.2     # Speed of the pedestrian [m/s]
        self._crossing_distance = 22.0  # Distance to cross [m]
        ...
        super(WalkingPedestrianCrossing2, self).__init__(
            "WalkingPedestrianCrossing2",
        ...
        if debug_mode:
            print("WalkingPedestrianCrossing2 scenario initialized with NO ego vehicle dependency")
    ...
    def _initialize_actors(self, config):
        ...
        walker = CarlaDataProvider.request_new_actor('walker.pedestrian.0006', spawn_transform)
        if walker is None:
...
def get_available_scenarios():
    ...
    """
    return {"WalkingPedestrianCrossing2": WalkingPedestrianCrossing2}