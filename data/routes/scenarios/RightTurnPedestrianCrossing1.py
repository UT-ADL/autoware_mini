...
class RightTurnPedestrianCrossing1(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=60):
        ...
        self._pedestrian_spawn_point = carla.Location(x=-34, y=-109, z=36.0)
        self._pedestrian_heading = 150  # in degrees, as requested
        
        # Scenario parameters
        self._adversary_speed = 1.5     # Speed of the pedestrian [m/s]
        self._first_segment_distance = 20.0  # First walking segment [m]
        self._second_segment_distance = 20.0  # Second walking segment after turn [m]
        ...
        self._second_heading = self._pedestrian_heading - 290
        ...
        super(RightTurnPedestrianCrossing1, self).__init__(
            "RightTurnPedestrianCrossing1",
        ...
        if debug_mode:
            print("RightTurnPedestrianCrossing1 scenario initialized with NO ego vehicle dependency")
    ...
    def _initialize_actors(self, config):
        ...
        walker = CarlaDataProvider.request_new_actor('walker.pedestrian.0010', spawn_transform)
        if walker is None:
...
def get_available_scenarios():
    ...
    """
    return {"RightTurnPedestrianCrossing1": RightTurnPedestrianCrossing1}