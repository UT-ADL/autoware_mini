...
class BusFromTheRight1(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._destination_coords = carla.Location(x=80, y=880, z=38)
        
        # Use the specific scene coordinates provided
        self._spawn_coords = carla.Location(x=153, y=460, z=36.0)
        self._spawn_yaw = 56.0  # Default spawn yaw in degrees - you can change this value
        ...
        self._waypoint_list = [
            [162.5, 471.5, 35.0, 10, 1],    # Direct waypoint
            [167.6, 476, 35, 25, 0],        # Road waypoint
            [190.439377, 510.731659, 35, 50, 0], # Road waypoint
            [207, 766.5, 37, 50, 0], # Road waypoint
        ...
        super(BusFromTheRight1, self).__init__(
            "BusFromTheRight1",
            ego_vehicles,
            config,
            world,
    ...
    def _create_route(self, agent, current_waypoint, destination_waypoint):
        ...
        print(f"Scenario: BusFromTheRight1")
    ...
    def terminate(self):
        ...
        super(BusFromTheRight1, self).terminate()

def get_available_scenarios():
    return {"BusFromTheRight1": BusFromTheRight1}