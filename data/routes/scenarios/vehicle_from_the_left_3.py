...
class VehicleFromTheLeft3(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._spawn_coords = carla.Location(x=180, y=409, z=34)
        self._initial_speed = 70  # km/h
        self._waypoint_list = [
        ...
        super(VehicleFromTheLeft3, self).__init__(
            "VehicleFromTheLeft3",
            ego_vehicles,
            config,
            world,
    ...
    def _initialize_actors(self, config):
        ...
        blueprint = self._world.get_blueprint_library().find('vehicle.audi.tt')
    ...
    def _log_scenario_info(self, complete_route):
        ...
        print(f"Scenario: VehicleFromTheLeft3")
    ...
    def terminate(self):
        ...
        super(VehicleFromTheLeft3, self).terminate()

def get_available_scenarios():
    return {"VehicleFromTheLeft_3": VehicleFromTheLeft3}