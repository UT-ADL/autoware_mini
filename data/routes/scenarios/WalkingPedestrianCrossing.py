...
class WalkingPedestrianCrossing(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=60):
        ...
        self._pedestrian_spawn_point = carla.Location(x=-8, y=120, z=35.0)
        self._pedestrian_heading = -20  # in degrees, as requested
        
        # Scenario parameters
        self._adversary_speed = 1.2    # Speed of the pedestrian [m/s]
        self._crossing_distance = 25.0  # Distance to cross [m]
        ...
        super(WalkingPedestrianCrossing, self).__init__(
            "WalkingPedestrianCrossing",
        ...
        if debug_mode:
            print("WalkingPedestrianCrossing scenario initialized with NO ego vehicle dependency")
    ...
    def _initialize_actors(self, config):
        ...
        walker = CarlaDataProvider.request_new_actor('walker.pedestrian.0005', spawn_transform)
        if walker is None:
    ...
    def _create_behavior(self):
        ...
        # Walk across immediately (no waiting)
...
def get_available_scenarios():
    ...
    """
    return {"WalkingPedestrianCrossing": WalkingPedestrianCrossing}