...
class RollerFromTheRight3(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._spawn_coords = carla.Location(x=-22.5, y=608, z=36.0)
        ...
        self._waypoint_list = [
            [-30, 599, 36.0, 15, 1],    # Direct waypoint
            [-38, 590, 36, 20, 1],        # Road waypoint
            [-46.5, 578, 36, 50, 0], # Road waypoint
        ...
        super(RollerFromTheRight3, self).__init__(
            "RollerFromTheRight3",
            ego_vehicles,
            config,
            world,
    ...
    def _initialize_actors(self, config):
        ...
        blueprint = self._world.get_blueprint_library().find('vehicle.kawasaki.ninja')
    ...
    def _create_route(self, agent, current_waypoint, destination_waypoint):
        ...
        print(f"Scenario: RollerFromTheRight3")
    ...
    def terminate(self):
        ...
        super(RollerFromTheRight3, self).terminate()

def get_available_scenarios():
    return {"RollerFromTheRight3": RollerFromTheRight3}