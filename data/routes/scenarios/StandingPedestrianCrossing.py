...
class StandingPedestrianCrossing(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=60):
        ...
        self._pedestrian_spawn_point = carla.Location(x=4, y=116, z=35.0)
        self._pedestrian_heading = -20  # in degrees, as requested
        
        # Scenario parameters
        self._adversary_speed = 1.5     # Speed of the pedestrian [m/s]
        self._crossing_distance = 18.0  # Distance to cross [m]
        ...
        super(StandingPedestrianCrossing, self).__init__(
            "StandingPedestrianCrossing",
        ...
        if debug_mode:
            print("StandingPedestrianCrossing scenario initialized with NO ego vehicle dependency")
    ...
    def _initialize_actors(self, config):
        ...
        walker = CarlaDataProvider.request_new_actor('walker.pedestrian.0003', spawn_transform)
        if walker is None:
...
def get_available_scenarios():
    ...
    """
    return {"StandingPedestrianCrossing": StandingPedestrianCrossing}