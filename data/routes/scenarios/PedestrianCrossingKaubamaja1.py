...
class PedestrianCrossingKaubamaja1(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=60):
        ...
        self._pedestrian_spawn_point = carla.Location(x=143, y=783, z=36.0)
        self._pedestrian_heading = 145  # in degrees, as requested
        
        # Scenario parameters
        self._adversary_speed = 1.6     # Speed of the pedestrian [m/s]
        self._crossing_distance = 36.0  # Distance to cross [m]
        ...
        super(PedestrianCrossingKaubamaja1, self).__init__(
            "PedestrianCrossingKaubamaja1",
        ...
        if debug_mode:
            print("PedestrianCrossingKaubamaja1 scenario initialized with NO ego vehicle dependency")
    ...
    def _initialize_actors(self, config):
        ...
        walker = CarlaDataProvider.request_new_actor('walker.pedestrian.0007', spawn_transform)
        if walker is None:
...
def get_available_scenarios():
    ...
    """
    return {"PedestrianCrossingKaubamaja1": PedestrianCrossingKaubamaja1}