...
class VehicleFromTheLeft2(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=600):
        ...
        self._destination_coords = carla.Location(x=346, y=547, z=36)
        self._spawn_coords = carla.Location(x=92.972916, y=228.156464, z=33.961136)
        self._initial_speed = 80  # km/h
        self._waypoint_list = [
        ...
        self._route_color = name_to_carla_color('cyan')
        self._start_color = name_to_carla_color('cyan')
        self._destination_color = name_to_carla_color('cyan')
        self._wp_color = name_to_carla_color('blue')
        ...
        super(VehicleFromTheLeft2, self).__init__(
            "VehicleFromTheLeft2",
            ego_vehicles,
            config,
            world,
    ...
    def _visualize_scenario(self, route=None):
        ...
        if self._agent_vehicle and self._agent_vehicle.is_alive:
            ...
            print(f"Agent 2 status - Distance: {distance:.2f}m, Speed: {speed:.2f}km/h")

    def _initialize_actors(self, config):
        # Select vehicle blueprint
        blueprint = self._world.get_blueprint_library().find('vehicle.ford.mustang')
    ...
    def _log_scenario_info(self, complete_route):
        ...
        print(f"Scenario: VehicleFromTheLeft2")
        ...
        #print(f"\nAgent 2 Waypoints in XML format:")
    ...
    def terminate(self):
        ...
        super(VehicleFromTheLeft2, self).terminate()

def get_available_scenarios():
    return {"VehicleFromTheLeft_2": VehicleFromTheLeft2}