...
class PedestrianCrossingKaubamaja3(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=60):
        ...
        self._pedestrian_spawn_point = carla.Location(x=118, y=803, z=36.0)
        self._pedestrian_heading = -30  # in degrees, as requested
        
        # Scenario parameters
        self._adversary_speed = 1.2     # Speed of the pedestrian [m/s]
        self._crossing_distance = 30  # Distance to cross [m]
        ...
        super(PedestrianCrossingKaubamaja3, self).__init__(
            "PedestrianCrossingKaubamaja3",
        ...
        if debug_mode:
            print("PedestrianCrossingKaubamaja3 scenario initialized with NO ego vehicle dependency")
    ...
    def _initialize_actors(self, config):
        ...
        walker = CarlaDataProvider.request_new_actor('walker.pedestrian.0009', spawn_transform)
        if walker is None:
...
def get_available_scenarios():
    ...
    """
    return {"PedestrianCrossingKaubamaja3": PedestrianCrossingKaubamaja3}