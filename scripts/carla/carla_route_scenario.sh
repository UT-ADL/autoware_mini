...
$SCENARIO_RUNNER_ROOT/scenario_runner.py --route $routes_file --route-id $route_id --agent $agent_file --sync --waitForEgo --output --host $host --port $port --timeout 60 --additionalScenario "$additional_scenarios"
