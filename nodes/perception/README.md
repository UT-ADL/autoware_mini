...
The Object Detection module is responsible for identifying and tracking objects around the vehicle, as well as predicting their future motion.

![Object Detection Architecture](/images/nodes/detection_architecture.png)
...
The object detection module takes inputs from:
...
![Object Detection Pipeline](/images/nodes/detection.png)
...
2. LiDAR point clouds are processed using one of the three methods (cluster or SFA) and optionally fused with processed detected objects from radar data
