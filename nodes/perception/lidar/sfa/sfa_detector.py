...
class SFADetector:
    def __init__(self):
        ...
        self.enable_fp16 = rospy.get_param("~enable_fp16")
        ...
        self.output_frame = rospy.get_param("/perception/output_frame")  # transform detected objects from lidar frame to this frame
    ...
    def load_onnx(self, onnx_path):
        ...
        self.model = onnxruntime.InferenceSession(onnx_path, providers=[
    ...
    def generate_autoware_objects(self, detections, transform):
        ...
        for i, (cls_id, x, y, z, height, width, length, yaw, score) in enumerate(detections.tolist()):
            ...
            detected_object.label = CLASS_NAMES[int(cls_id)]
