...
class DetectionRangeFilter:
    ...
    def detected_objects_callback(self, msg):
        ...
        base_link_point = Point(x=self.current_pose.position.x, y=self.current_pose.position.y, z=self.current_pose.position.z)
        ...
        for obj in msg.objects:
            ...
            for x, y, z in convex_hull:
                distance = get_distance_between_two_points_2d(car_front, Point(x=x, y=y, z=z))
